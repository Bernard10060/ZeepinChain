# ZeepinChain Signature Server Tutorials

[English|[中文](sigsvr_CN.md)]

ZeepinChain Signature Server - sigsvr is a rpc server for signing transactions. The signature server is bound to the 127.0.0.1 address and only supports signature requests sent by the local machine.

* [ZeepinChain Signature Server Tutorials](#ZeepinChain-signature-server-tutorials)
