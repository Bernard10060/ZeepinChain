...
This document describes the restful api format for the http/https used in the Onchain ZeepinChain.
...
| [get_version](#21-get_version) |  GET /api/v1/version | return the version of ZeepinChain |
| [post_raw_tx](#22-post_raw_tx) | post /api/v1/transaction?preExec=0 | send transaction to ZeepinChain network |
...
```
{
    ...
    "Result": {
        ...
        "Name": "ZPT",
        "CodeVersion": "1.0",
        "Author": "ZeepinChain Team",
        "Email": "contact@zeepin.io",
        "Description": "ZeepinChain Network ZPT Token"
    }
}
```
...
```
You can use the ZeepinChain-go-sdk to generate hex code, reference to [example](rpc_api.md#8-sendrawtransaction)
