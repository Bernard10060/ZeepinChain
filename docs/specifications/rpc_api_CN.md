...
本文档是ZeepinChain的RPC接口文档，详细定义了每种接口的参数与返回值。
...
| [getversion](#10-getversion) |  | 得到运行的ZeepinChain版本 |  |
...
Hex: 签名后的交易序列化成的十六进数据。可以参考ZeepinChain-go-sdk/rpc.go中的NewNativeInvokeTransaction方法生成。
