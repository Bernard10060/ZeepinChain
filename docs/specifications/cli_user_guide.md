...
To deploy ZeepinChain test network with dBFT consensus algorithm requires a minimum of 4 nodes, and to deploy ZeepinChain test network with the VBFT consensus algorithm requires a minimum of 7 nodes.
