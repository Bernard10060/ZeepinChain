...
本文档是ZeepinChain的websocket接口文档，详细定义了各个接口所需的参数与返回值。
...
| [sendrawtransaction](#11-sendrawtransaction) | data,[PreExec] | 向ZeepinChain网络发送交易, 如果 preExec=1，则交易为预执行 |
...
```
可以使用ZeepinChain-go-sdk生成十六进制数据，参考这个[例子](rpc_api_CN.md#8-sendrawtransaction)
